 ...
 * 
 */
@WebServiceClient(name = "FlightService", targetNamespace = "http://client.juddi/", wsdlLocation = "file:/C:/Users/coper/IdeaProjects/ws_juddi/src/main/resources/wsdl/FlightService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName FLIGHTSERVICE_QNAME = new QName("http://client.juddi/", "FlightService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/coper/IdeaProjects/ws_juddi/src/main/resources/wsdl/FlightService.wsdl");
    ...
    public FlightService getFlightServicePort() {
        return super.getPort(new QName("http://client.juddi/", "FlightServicePort"), FlightService.class);
    }
    ...
    public FlightService getFlightServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://client.juddi/", "FlightServicePort"), FlightService.class, features);
    }
